...
class LogTool(ColorTool):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        print(
            f"\n              {self._PINK}vc+{self.RESET}              System : {self._LIGHT_CYAN}{platform.system()}\n"
    ...
    def Channel(
        self,
        channel: discord.TextChannel | discord.VoiceChannel | discord.ForumChannel | discord.Thread | discord.DMChannel,
    ) -> str:
